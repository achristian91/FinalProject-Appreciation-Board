...
import Button from "./assets/Material/CustomButtons/Button.jsx";
import GridContainer from "./assets/Material/Grid/GridContainer.jsx";
import GridItem from "./assets/Material/Grid/GridItem.jsx";
import HeaderLinks from "./assets/MaterialHeader/HeaderLinks.jsx";
...
import work1 from "a./ssets/img/examples/olu-eletu.jpg";
                ...
                <GridItem xs={12} sm={12} md={6}>
                  <div className={classes.profile}>
                    ...
                    <div className={classes.name}>
                      <h3 className={classes.title}>User Page example</h3>
                      <h6>DESIGNER</h6>
